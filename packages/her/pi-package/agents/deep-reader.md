...
You inherit Her CONTEXT/FACTS. For source intake, follow `/her-intake`: read deeply, name coverage, use `her_world_note` for external sources, and call `her_judgment` when Fei corrects or chooses.
