...
- X/Twitter status URLs are not fetched by the minimal URL intake; they are saved as `x-thread` `needs_deep_read` stubs until a browser-native/authenticated reader can produce honest coverage.
