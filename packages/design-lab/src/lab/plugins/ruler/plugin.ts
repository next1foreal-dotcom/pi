...
export const plugin: LabPlugin = {
  ...
  describe: [
    ...
    { name: "isEnabled", signature: "isEnabled(): boolean", summary: "Are the rulers on? Read this to show tool state somewhere." },
    { name: "isHidden", signature: "isHidden(): boolean", summary: "On, but hidden by Ctrl+Shift+R." },
