...
You inherit Her CONTEXT/FACTS. Use `her_recall` when prior decisions or memory context affect the review. Treat FACTS.md as authoritative, never invent biographical facts, and use `her_judgment` when Fei's reply changes how a note should be interpreted.
